(function($){
    ...
    $.fn.wBox = function(options){
        ...
        var  wBoxHtml = '<div id="wBox"><div class="wBox_popup"><table><tbody><tr><td><div class="wBox_body">' + (_this.YQ.noTitle ? '' : '<div class="wBox_itemTitle" style="position:relative"><h3>' + _this.YQ.title + '</h3><div class="wBox_close" style="position:absolute;right:10px;top:10px;"></div></div>')+'<div class="table_c"><div class="table_input" id="wBoxContent"></div></div></td></tr></tbody></table></div></div>', B = null, C = null, $win = $(window),$t=$(this);//B背景，C内容jquery div  
